...
function BuyTicket() {
  ...
  return (
    <div className="p-2">
     ...
     <div className="flex items-center justify-center w-[70vw] mx-auto min-h-full bg-gray-100 text-gray-800 p-8">
            ...
            <div>
                ...
                <div className="bg-white rounded mt-4 shadow-lg py-6">
                    ...
                    <div className="flex flex-col px-8 pt-4">
                        <button className="flex items-center justify-center bg-blue-600 text-sm font-medium w-full h-10 rounded text-blue-50 hover:bg-blue-700">Make Purchase</button>
